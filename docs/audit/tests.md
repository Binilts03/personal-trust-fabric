...
| `conformance`                                                                       | normative MUST/SHOULD obligations extracted from `docs/spec/` (authority, capability, disclosure, execution, adapters, digest)                         |
...
| `travel`                                                                              | route/class/traveler/fare/date bounds, grant allow/deny matrix, `/travel/book` execution with domain-neutral receipt                                  |
